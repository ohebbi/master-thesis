...
% We obtain the calculated information by following  this is presented in  . Similar to AFLOW-query, this code listing is dependent on MP-data and will apply for a query if the data is not present.
