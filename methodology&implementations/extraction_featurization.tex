...
\noindent The code listed in \autoref{lst:CIQuery} gives an easy example to steps $2-4$ with experimental data as a filter, which results in an almost instant query.
