\begin{figure}[!ht]
  ...
  \end{forest}
\vspace*{-120mm}
\caption{A figure visualizing the predictions of potential qubit candidates for all models for the augmented Ferrenti approach. The green nodes display the number of predicted good candidates, while the bad candidates are marked red.}
