\begin{wrapfigure}{r}{0.5\textwidth}
    ...
    \begin{tikzpicture}[font=\normalsize]
        \begin{axis}[
          ...
          \node[OptimumStyle] at (axis cs:0.9,2) {Optimal model\\complexity};
        ...
        \end{axis}
    \end{tikzpicture}
  \caption{A schematic representation of the bias-variance tradeoff as a function of model complexity, adapted from Ref. \cite{Guido2016}. The error associated with a model can be decomposed into variance and bias, where a compromise between the lowest bias and variance corresponds to the optimal model complexity. }
