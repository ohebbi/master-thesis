...
\end{subfigure}
\par\bigskip
\caption{Schematic representation of different degrees of ordered structures, where (a) shows a crystal of a simple cubic lattice, (b) shows a polycrystalline hexagonal lattice, and (c) shows an amorphous lattice.}
